...
class ExpenseOperationTest < Minitest::Spec
  ...
  describe "date formats and shortcuts" do
    ...
    it { assert_pass Expense::Create, { invoice_date: "24/12" }, { invoice_date: Date.parse("24.12.2018") } }
    it { assert_pass Expense::Create, { invoice_date: "24/2" }, { invoice_date: Date.parse("24.02.2018") } }
  ...
  describe "created_at, updated_at" do
    ...
    it { assert_pass Expense::Create, {}, created_at: ->(actual:, **) { actual < Expense::Create.(params: params_pass)[:model].created_at } }
  end
  ...
  describe "Update" do
    let(:expense) { Expense::Create.( params: params_pass )[:model] }
